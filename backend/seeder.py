...
c1 = Category(id=1, type="Science")
db.session.add(c1)
db.session.commit()


c1 = Category(id=2, type="Art")
db.session.add(c1)
db.session.commit()


c1 = Category(id=3, type="Geography")
db.session.add(c1)
db.session.commit()


c1 = Category(id=4, type="History")
db.session.add(c1)
db.session.commit()


c1 = Category(id=5, type="Entertainment")
db.session.add(c1)
db.session.commit()


c1 = Category(id=6, type="Sports")
db.session.add(c1)
db.session.commit()


q1 = Question(question='Whose autobiography is entitled \'I Know Why the Caged Bird Sings\'',
              answer='Maya Angelou', difficulty=2, category=4)
db.session.add(q1)
db.session.commit()
